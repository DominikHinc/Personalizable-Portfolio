export const HealthAdvisorDetails = [
    {
        title:"Genesis",
        gif:require('../../../assets/Gifs/HealthAdvisor/FirstPart.gif'),
        text:'This is genesis text'
    },
    {
        title:"Time in development",
        gif:require('../../../assets/Gifs/HealthAdvisor/SecondPart.gif'),
        text:'This is Time in development me text'
    },
    {
        title:"History",
        gif:require('../../../assets/Gifs/HealthAdvisor/ThirdPart.gif'),
        text:'This is history me text'
    },
    {
        title:"What I knew before starting this project",
        gif:require('../../../assets/Gifs/HealthAdvisor/ForthPart.gif'),
        text:'This is what i knew me text'
    },
    {
        title:"What I learned from creating this project",
        gif:require('../../../assets/Gifs/HealthAdvisor/FifthPart.gif'),
